...
//  FoodTracker
//
//  Created by Mazen Chami on 1/8/15.
//  Copyright (c) 2015 Mazen Chami. All rights reserved.
//
...
class ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate, UISearchControllerDelegate, UISearchResultsUpdating {
    ...
    let kAppID = "026255bc"
    let kAppKey = "ede2a6c51a18f1d45b15773a9c209201"
...
//            println(jsonDictionary)
    ...
    func requestFavoritedUSDAItems() {
        ...
        let managedObjectContext = appDelgate.managedObjectContext
        self.favoritedUSDAItems = managedObjectContext?.executeRequest(fetchRequest, error: nil) as [USDAItem]
